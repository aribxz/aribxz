...
I'm **Mohammad Arib Salim**, a **Machine Learning focused Computer Science undergraduate** at **IMS Engineering College**.

My interest in Machine Learning started from a simple question:

> **"How can a machine learn patterns from data and make decisions on its own?"**

Since then, I've been exploring machine learning through both theory and hands-on implementation. I enjoy understanding how algorithms work internally and applying them to solve practical problems, ranging from regression and classification to sports analytics and AI-powered applications.
...
A complete end-to-end machine learning project focused on predicting residential property prices using the **Ames Housing Dataset**. The project explores multiple regression algorithms, extensive feature engineering, hyperparameter tuning, and rigorous model evaluation to identify the most effective predictive model.

Rather than relying on a single algorithm, the project compares several regression techniques to understand their strengths, limitations, and generalization performance on real-world housing data.
...
- Cross Validation
- Practical Regression Pipelines
...
An ongoing football analytics project designed to predict **Home Win**, **Draw**, or **Away Win** outcomes before kickoff using advanced machine learning techniques and statistical modeling.

The project has gradually evolved from classical decision trees into a hybrid prediction system combining ensemble learning with probabilistic football models.

Special emphasis has been placed on preventing data leakage through chronological validation and realistic feature engineering.
...
| **Scale** | Multiple Premier League Seasons |
...
- Extensive feature experimentation
...
HAS is my most ambitious ongoing project.

It is a modular AI assistant designed to transform long-form educational content into structured, searchable, high-quality study material.

Instead of acting as a chatbot, HAS focuses on building an intelligent knowledge pipeline capable of processing YouTube lectures, PDFs, presentations, and documents into well-organized notes.

The project emphasizes scalable software architecture, modular design, and production-quality engineering principles.

---

| Category | Details |
|-----------|---------|
| **Stack** | Python, Flask, Groq API, Markdown |
...
- High-quality AI note generation
...
StudyScore is a machine learning application that predicts student exam performance based on lifestyle and academic factors.

The project combines feature engineering with regression modeling and is deployed as an interactive Flask web application, allowing users to experiment with different study habits and instantly receive performance predictions.
...
Working on real-world machine learning solutions in a collaborative engineering environment, contributing to the development of AI-driven applications while strengthening practical skills in model development, experimentation, and deployment.

### Responsibilities

- Developing and improving machine learning models
- Data preprocessing and feature engineering
- Model evaluation and experimentation
- Collaborating with engineering teams
- Researching modern AI techniques
- Building scalable ML solutions

**Skills:** `Python` `Machine Learning` `Scikit-learn` `Data Analysis` `Git` `Model Evaluation`
...
<img src="https://streak-stats.demolab.com?user=aribxz&theme=tokyonight&hide_border=true"/>
...
- Krish Naik's Machine Learning Series
